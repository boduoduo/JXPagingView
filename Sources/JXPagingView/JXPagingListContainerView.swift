...
class JXPagingListContainerScrollView: UIScrollView, UIGestureRecognizerDelegate {
    ...
    override func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
        if isCategoryNestPagingEnabled, let panGesture = gestureRecognizer as? UIPanGestureRecognizer, let gestureView = panGesture.view, gestureView.isKind(of: UIScrollView.self) {
